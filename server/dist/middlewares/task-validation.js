...
export const validateTaskCreation = async (c, next) => {
    try {
        ...
        if (!due_date)
            throw new BadRequestError("Missing required field: due_date");
        if (!group_id)
            throw new BadRequestError("Missing required field: group_id");
    ...
    `;
        ...
        if (groupMemberResult.length === 0) {
            throw new ForbiddenError("You must be a member of the group to create tasks");
        }
...
export const validateTaskUpdate = async (c, next) => {
    try {
...
export const validateTaskStatusUpdate = async (c, next) => {
    try {
    ...
    `;
        ...
        if (tasks.length === 0) {
            throw new BadRequestError("Task not found or you are not a member of this group");
        }
...
export const validateTaskCreationAuthorization = async (c, next) => {
    try {
    ...
    `;
        ...
        const groupMembers = membersResult;
