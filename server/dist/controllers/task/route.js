...
import { createTask, updateTask, updateTaskStatus, deleteTask, getTaskById, getTasksByGroupId, getTasksByUserId, getAllTasks, } from "./task.controller";
import { validateTaskCreation, validateTaskUpdate, validateTaskStatusUpdate, validateTaskCreationAuthorization, } from "@/middlewares/task-validation";
...
validateTaskCreation, validateTaskCreationAuthorization, createTask)
