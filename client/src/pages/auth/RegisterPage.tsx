...
const RegisterPage = () => {
  ...
  // Clear error message when form data changes after an error
  useEffect(() => {
    if (error) setError("");
  }, [error, formData]);
  ...
  return (
    <div className="min-h-screen flex overflow-hidden">
      ...
      <div className="flex flex-col justify-center items-center w-full md:w-1/2 bg-white px-8 py-12 overflow-hidden max-h-screen">
